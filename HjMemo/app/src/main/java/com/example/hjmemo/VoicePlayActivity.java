...
import com.example.hjmemo.VoiceRecordingActivity.RemainingTimeCalculator;
...
public class VoicePlayActivity extends AppCompatActivity {
	...
	Runnable mUpdateTimer = new Runnable()
	{
        public void run()
        {
        	...
        	else
        	{
        		...
        		{
        			mStartStopBtn.setImageResource(R.drawable.btn_voice_play);
        			isPlaying = false;
        			isHolding = false;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mStartStopBtn = (ImageButton) findViewById(R.id.playing_stopBtn);
		mStartStopBtn.setImageResource(R.drawable.btn_voice_pause);
		...
		Button closeBtn = (Button) findViewById(R.id.playing_closeBtn);
