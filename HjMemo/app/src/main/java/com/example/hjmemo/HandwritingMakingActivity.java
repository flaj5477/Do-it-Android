...
public class HandwritingMakingActivity extends Activity {
	...
	public void setTopLayout() {
		...
		mColorBtn = (ImageButton) findViewById(R.id.colorBtn);
		mPenBtn = (ImageButton) findViewById(R.id.penBtn);
		mEraserBtn = (ImageButton) findViewById(R.id.eraserBtn);
        ...
        mColorLegendBtn = new ImageButton(this);
