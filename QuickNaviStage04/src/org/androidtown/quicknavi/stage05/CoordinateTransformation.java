 ...
 * GPoint out_pnt = CoordinateTransformation.convert(CoordinateTransformation.TM128, GeoTrans.WGS84, pnt);
 * 
 *
 */
public class CoordinateTransformation {
	...
	public static GPoint convert(int srctype, int dsttype, GPoint in_pt) {
	...
	public static void geo2tm(int dsttype, GPoint in_pt, GPoint out_pt) {
		double x, y;
	...
	public static void tm2geo(int srctype, GPoint in_pt, GPoint out_pt) {
	...
	public static double getDistancebyGeo(GPoint pt1, GPoint pt2) {
	...
	*/
	...
	private static void transform(int srctype, int dsttype, GPoint point) {
		if (srctype == dsttype)
			return;
	...
	private static boolean geodetic_to_geocentric (int type, GPoint p) {
	 ...
	 */
	public static void geocentric_to_geodetic (int type, GPoint p) {
   ...
   //  defn = coordinate system definition,
	...
	private static void geocentric_to_wgs84(GPoint p) {
	...
	private static void geocentric_from_wgs84(GPoint p) {
	...
	public static GPoint fromRectangularToGeodetic(GPoint pnt) {
		double C,B;
		double Q;
		double M;
		double F = 6.0D;
