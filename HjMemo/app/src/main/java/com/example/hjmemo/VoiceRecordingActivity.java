...
import com.example.hjmemo.VoiceRecorder.OnStateChangedListener;
...
public class VoiceRecordingActivity extends Activity implements OnStateChangedListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG,"화정 -> VoiceRecordingActivity.java의 onCreate() 까지 실행함");
	...
	public void setBottomBtns()
	{
		...
		mStartStopBtn = (ImageButton) findViewById(R.id.recording_startstopBtn);
		mStartStopBtn.setImageResource(R.drawable.btn_voice_record);
		mCancelBtn = (Button) findViewById(R.id.recording_cancelBtn);
	...
	public void startVoiceRecording()
    {
	 ...
	 public void voiceRecordingStart() {
        ...
        if (!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {     //sd카드가 존재하지 않을경우
	 ...
	 public void stopVoiceRecording() {
		 ...
		 mStartStopBtn.setImageResource(R.drawable.btn_voice_stop);
