...
public class UTMK {
	...
	public static double v(double z) {
		return (1-0.25*z*(1+z/16*(3+1.25*z)));
	}
	
	public static double l(double z) {
	...
	public static double e(double D, double C, double B, double A, double z) {
		return (D*z-C*Math.sin(2*z)+B*Math.sin(4*z)-A*Math.sin(6*z));
	}
	
	public static double t(double z) {
		if(z < 0) {
			return(-1);
		} else {
			return(1);
